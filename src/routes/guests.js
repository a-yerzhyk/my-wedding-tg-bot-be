...
module.exports = async (fastify) => {
  ...
  fastify.patch('/requests/:userId', {
    ...
    const textForUser = newStatus === 'approved'
      ? "Ваш запит на участь у святкуванні успішно підтверджений!🥳 Тепер ви можете надсилати запрошення іншим гостям, чиїх контактів у нас немає. Для цього перезавантажте апку. Також незабаром з'явиться можливість завантаження ваших фото зі свята!"
